...
import { reviewSelector } from '../redux/reviewSlice'
import ReviewCard from './ReviewCard';

const ReviewPage = () => {
    const reviewData = useSelector(reviewSelector);
  ...
  return (
    <div className='flex items-center justify-center flex-col'>
        <h1 className='md:text-[45px] texxt-[30px] font-semibold text-center mt-[30px] px-[20px]'>Real Reviews for Real Courses</h1>
